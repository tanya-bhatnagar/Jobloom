...
const JobCard  = ({ job }) => {
  ...
  return (
    <div className='border p-6 shadow rounded '>
      ...
      <div className='flex items-center gap-3 mt-2 texts-xs'>
      ...
      <div className='mt-4 flex gap-4 text-sm'>
        ...
        <button onClick={()=> {navigate(`/apply-job/${job._id}`); scrollTo(0,0)}} className='text-gray-500 border-gray-500 rounded px-4 py-2 cursor-pointer' >Learn more</button>
      </div>
    </div>
  )
}
