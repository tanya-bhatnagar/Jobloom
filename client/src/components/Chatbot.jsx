...
//   return (
//     <div className="fixed bottom-5 right-5 w-100 bg-white rounded-xl shadow-lg flex flex-col overflow-hidden">
//       <div className="bg-blue-600 text-white px-4 py-2 font-bold">AI Chatbot</div>
//       <div className="flex-1 p-3 overflow-y-auto h-96">
